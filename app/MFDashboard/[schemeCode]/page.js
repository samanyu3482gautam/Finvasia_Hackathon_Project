...
export default function MFDetailsPage() {
  ...
  return (
    ...
    <FutureVisionModal isOpen={showFutureVision} onClose={() => setShowFutureVision(false)}>
      <div className="bg-[#181f31] rounded-xl p-6 shadow-lg w-full max-w-4xl h-fit">
        <div className="space-y-3 mb-4 text-base">
          ...
          <div className="flex justify-between items-center bg-emerald-900/30 border border-emerald-500/50 p-4 rounded-xl shadow-[0_0_20px_rgba(16,185,129,0.15)] my-4 transform hover:scale-[1.02] transition-all">
            <span className="text-emerald-200 font-bold flex items-center gap-2 text-lg">
            ...
            <span className="font-black text-3xl text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-300 tracking-tight drop-shadow-lg">
              {formatPct((monteCarlo.probability_positive_return || 0) / 100)}
            </span>
          </div>
          <div className="flex justify-between items-center">
