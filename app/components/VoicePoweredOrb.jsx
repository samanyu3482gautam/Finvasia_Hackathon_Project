...
export const VoicePoweredOrb = ({
  className,
  hue = 190, // Default to a cyan/blue consistent with fintech theme
  ...
  const frag = /* glsl */ `
    ...
    const vec3 baseColor1 = vec3(0.5, 0.5, 0.5); // Slate
    const vec3 baseColor2 = vec3(0.3, 0.35, 0.45); // Steel
    const vec3 baseColor3 = vec3(0.05, 0.06, 0.08); // Graphite
    ...
    vec4 draw(vec2 uv) {
      // Use direct colors for a consistent formal theme
