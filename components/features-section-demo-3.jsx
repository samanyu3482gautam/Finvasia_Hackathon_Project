  ...
  const features = [
    {
      ...
      description:
        "Track mutual funds, cryptocurrencies, and other assets in real time through a single intelligent dashboard enriched with live data and analytics.",
    ...
    },
    {
      ...
      description:
        "Leverage artificial intelligence to uncover trends, evaluate risk, and gain actionable insights tailored to your investment goals.",
      skeleton: <SkeletonTwo />,
      className: "border-b col-span-1 lg:col-span-2 dark:border-neutral-800",
    },
    {
      title: "Learn Finance the Smart Way",
      description:
        "Explore simplified educational content including videos, explainers, and guides designed to build confidence in stocks, crypto, and mutual funds.",
      skeleton: <SkeletonThree />,
      className:
        "col-span-1 lg:col-span-3 lg:border-r dark:border-neutral-800 lg:pb-6",
    },
    {
      title: "Connected to Global Markets",
      description:
        "Experience worldwide financial connectivity with real-time data, global market coverage, and secure digital infrastructure built for modern investors.",
      ...
      <div className="relative z-20 py-6 lg:py-12 max-w-7xl mx-auto">
        <div className="px-8">
          ...
          <p className="text-sm lg:text-base max-w-2xl my-4 mx-auto text-white text-center font-normal">
            ArthSaarthi combines AI, real-time analytics, and education to help you
